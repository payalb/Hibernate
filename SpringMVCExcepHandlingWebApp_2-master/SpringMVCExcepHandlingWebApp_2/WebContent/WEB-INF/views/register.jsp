...
<body>
	...
	<form:form action="/SpringMVCExcepHandlingWebApp_2/registerSuccess"
		method="post" commandName="student">
		<h2 align="center"><spring:message code="label.register.header"/></h2>
		<h3 align="center"><a href="/SpringMVCExcepHandlingWebApp_2?lang=en">English</a> | <a href="/SpringMVCExcepHandlingWebApp_2?lang=fr">French</a></h3>
		<table align="center">
			<tr>
